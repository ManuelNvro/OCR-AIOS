...
model TGOV1 "TGOV1 - Steam Turbine-Governor"
  ...
  Modelica.Blocks.Math.Add add1(k2=-1) annotation (Placement(transformation(extent={{180,-10},
            {200,10}})));
  Modelica.Blocks.Sources.Constant REF(k=P_REF) annotation (Placement(transformation(extent={{-120,-4},
            {-100,16}})));
...
equation
  connect(REF.y, add.u1) annotation (Line(points={{-99,6},{-60,6},{-60,5.8},{
