...
equation
  ...
  connect(wind_Power_Model1.Theta, limIntegrator1.y) annotation (Line(
      ...
      points={{-112.068,-39.4497},{-117.08,-39.4497},{-117.08,28.1499},{
          -91.0554,28.1499},{177.065,28.1499},{177.065,-16.8501},{174.065,
          -16.8501}},
      color={0,0,127}));
  ...
  connect(Change_Base.y, rotor_Model1.Pe) annotation (Line(
      ...
      points={{-7.7799,19.4913},{1.2201,19.4913},{1.2201,-12.8593},{2.6699,
          -12.8593},{2.6699,-13.2639}},
      color={0,0,127}));
