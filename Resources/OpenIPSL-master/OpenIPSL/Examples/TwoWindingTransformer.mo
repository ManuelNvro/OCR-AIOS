...
equation
  connect(gENROE.PMECH, gENROE.PMECH0) annotation (Line(points={{-95.4,10},{-98,
          10},{-98,26},{-50,26},{-50,10},{-56.3,10}},  color={0,0,127}));
  connect(gENROE.EFD, gENROE.EFD0) annotation (Line(points={{-95.4,-10},{-98,
          -10},{-98,-24},{-50,-24},{-50,-10},{-56.3,-10}},
                                                       color={0,0,127}));
  connect(gENROE.p, BUS01.p)
    annotation (Line(points={{-58,0},{-40,0}},   color={0,0,255}));
  ...
  connect(pwLine1.p, BUS02.p) annotation (Line(points={{41,30},{4,30},{4,0},{0,
          0}},    color={0,0,255}));
  connect(pwLine3.p, BUS02.p) annotation (Line(points={{21,-30},{4,-30},{4,0},{
          0,0}},     color={0,0,255}));
  connect(constantLoad.p, BUS02.p)
    annotation (Line(points={{2,-40},{2,0},{0,0}},   color={0,0,255}));
  connect(pwLine3.n, BUS03.p) annotation (Line(points={{39,-30},{39,-30},{50,
          -30}},     color={0,0,255}));
  connect(BUS03.p, pwLine4.p)
    annotation (Line(points={{50,-30},{61,-30}},      color={0,0,255}));
  connect(BUS1.p, gENCLS.p) annotation (Line(points={{90,0},{106,0},{106,0}},
        color={0,0,255}));
  connect(pwLine1.n, BUS1.p) annotation (Line(points={{59,30},{86,30},{86,0},{
          90,0}},     color={0,0,255}));
  connect(pwLine4.n, BUS1.p) annotation (Line(points={{79,-30},{86,-30},{86,0},
          {90,0}},       color={0,0,255}));
