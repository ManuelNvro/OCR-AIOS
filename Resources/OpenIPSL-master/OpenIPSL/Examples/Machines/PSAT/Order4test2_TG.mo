...
equation
  connect(Generator.p, bus.p) annotation (Line(points={{-10,0},{-4.25,0},{-4.25,
          0},{0,0}}, color={0,0,255}));
  connect(TGtypeII1.pm, Generator.pm) annotation (Line(points={{-58.75,-5.5},{
          -52,-5.5},{-52,-7.5},{-43,-7.5}},
                             color={0,0,127}));
  connect(Generator.pm0, TGtypeII1.pm0) annotation (Line(points={{-37,-16.5},{
          -37,-25},{-50,-25},{-50,15},{-72.5,15},{-72.5,9.5}},
                                                           color={0,0,127}));
  connect(Generator.vf0, Generator.vf) annotation (Line(points={{-37,16.5},{-37,
          20},{-45,20},{-45,7.5},{-43,7.5}}, color={0,0,127}));
  connect(Generator.w, TGtypeII1.w) annotation (Line(points={{-8.5,13.5},{-4,
          13.5},{-4,26},{-92,26},{-92,-5.5},{-87.5,-5.5}},                                                                    color={0,0,127}));
